...
int main (int argc, char** argv) {
    ...
    if (argc < 3 || argc > 3) {
        cout<<"uso: ./clasificador_de_distribuciones_cuda "
            <<"archivo_entrada "
            <<"archivo_salida "
            <<endl;
        return 0;
    ...
    ManejadorDeArchivosCuda manejador_de_archivos;
    ...
    */
    ...
    inicio = clock();
    AnalizadorDeDatosCuda analizador_de_datos;
    ...
    */
    ...
    stat = manejador_de_archivos.GenerarSalida(archivo_salida,
                                               *grupos,
                                               msg,
                                               ManejadorDeArchivosCuda::reemplazar);
    /*  ---
    ...
    */
    ...
    {
    case 0:
        cout<<"Generaci�n de archivo de salida finalizada"
